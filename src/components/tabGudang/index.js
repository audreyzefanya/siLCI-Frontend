...
const TabNavigation = ( {tabAktif} ) => {
  ...
  const handleNavigate = (tabName) => {
    ...
    } else if (tabName === 'Riwayat Barang') {
      navigate('');
  ...
  return (
    <div className="flex">
      ...
      <TabItem tabName="Riwayat Barang" isActive={activeTab === 'Riwayat Barang'} onClick={() => { handleTabClick('Riwayat Barang'); handleNavigate('Riwayat Barang'); }} />
